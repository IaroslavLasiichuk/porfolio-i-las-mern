...
function Form() {
  ...
  return (
    <div
      id="contact"
      className="relative isolate bg-white min-h-screen pt-24 sm:pt-24 flex flex-col font-custom"
    >
      <Gradient />
      <div className="mx-auto max-w-7xl px-0 lg:px- flex-1">
        ...
        <div className="mx-auto mt-10  grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 ">
          <form
